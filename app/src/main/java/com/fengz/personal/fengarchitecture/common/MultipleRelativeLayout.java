...
public class MultipleRelativeLayout extends RelativeLayout {
    ...
    public MultipleRelativeLayout(Context context) {
        this(context, null);
    }

    public MultipleRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MultipleRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MultipleRelativeLayout, defStyleAttr, 0);
        mEmptyViewResId = a.getResourceId(R.styleable.MultipleRelativeLayout_emptyView, R.layout.empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.MultipleRelativeLayout_errorView, R.layout.error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleRelativeLayout_loadingView, R.layout.loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultipleRelativeLayout_noNetworkView, R.layout.no_network_view);
        mContentViewResId = a.getResourceId(R.styleable.MultipleRelativeLayout_contentView, NULL_RESOURCE_ID);
        a.recycle();
